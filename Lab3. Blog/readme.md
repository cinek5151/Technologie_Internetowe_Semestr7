...
Aplikacja pozwala na symulowanie działania bloga, pozwalając na dodawanie wpisów oraz zarządznie komentarzami (dodawanie komentarza oraz jego akceptacja do wyświetlenia na stronie).
