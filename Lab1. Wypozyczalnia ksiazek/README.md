...
Aplikacja pozwala na symulowanie działania biblioteki, pozwalając na dodawanie książek, członków oraz wypożyczeń a także na zarządzenie wypożyczeniami.
...
f) library.db - plik bazy danych sqlite, tworzy się automatycznie przy pierwszym uruchomieniu aplikacji  
